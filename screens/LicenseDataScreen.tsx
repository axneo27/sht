...
type LicenseDataScreenNavigationProp = StackNavigationProp<RootStackParamList, 'LicenseData'>;

interface Props {
  navigation: LicenseDataScreenNavigationProp;
}

export const LicenseDataScreen: React.FC<Props> = ({ navigation }) => {
  ...
  const onSubmit = (data: Partial<ProtocolFormData>) => {
    updateFormData(data);
    navigation.navigate('DamageType');
  };
